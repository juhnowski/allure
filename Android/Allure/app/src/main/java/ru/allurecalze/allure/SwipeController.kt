...
abstract class SwipeControllerActions(val app:Allure, val context:Context) {
...
internal class SwipeController(buttonsActions: SwipeControllerActions, val context: Context) : Callback() {
    ...
    private fun drawButtons(c: Canvas, viewHolder: RecyclerView.ViewHolder) {
        ...
        p.color = ContextCompat.getColor(context, R.color.colorBlueButton)//Color.BLUE
        c.drawRoundRect(leftButton, corners, corners, p)
        drawText("Сохр.", c, leftButton, p)
        ...
        drawText("Скрыть", c, rightButton, p)
