...
//                if (advert_id!=null) {
//                    ServerTask(prepareSetSelectionJson(advert_id), this@Allure, HandlerSetSelection(app, context)).execute()
//                }
//            }
        }, this@MyChat)
    ...
    fun initSenders(){
        ...
        senderList.add(0, Sender("Аллуре менеджер",5,1,""))
        senderList.add(1,Sender("Маша Иванова",0,1,""))
        senderList.add(2,Sender("Катя Полякова",1,1,""))
        senderList.add(3,Sender("Света Лазарева",2,1,""))
